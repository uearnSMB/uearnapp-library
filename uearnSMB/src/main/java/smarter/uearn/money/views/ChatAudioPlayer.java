...
public class ChatAudioPlayer extends LinearLayout implements OnPreparedListener, OnCompletionListener, OnSeekBarChangeListener, OnClickListener {
    ...
    public ChatAudioPlayer(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
        init();
    }
    ...
    private void init() {
        inflate(getContext(), R.layout.chat_player, this);
