...
public class SuggestionsFragment extends Fragment {
    ...
    SuggestionsInterface sendMessage;
    ...
    public void onAttach(Context context) {
        ...
        try{
            sendMessage = (SuggestionsInterface) getActivity();
        }catch (Exception e){
            e.printStackTrace();
        }
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        etSuggestions=view.findViewById(R.id.etSuggestions);
        etSuggestions.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if (s.length()>0){
                    sendMessage.sendSuggestions(etSuggestions.getText().toString().trim());
                }
            }
        });
