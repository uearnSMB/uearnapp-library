...
public class SMEAdapter extends RecyclerView.Adapter {

    Context context;
    private List<SMEMessage> mMessages;
    private String userName;
    private static final int VIEW_TYPE_MESSAGE_SENT = 1;
    private static final int VIEW_TYPE_MESSAGE_RECEIVED = 2;
    private static final int VIEW_TYPE_USER_LEFT = 3;
    private static final int VIEW_TYPE_MESSAGE_BUTTON = 4;
    public SMEAdapter(Context context, List<SMEMessage> messages, String userName){
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        ...
        /*view = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.item_button_received, viewGroup, false);
        return new SMEAdapter.MessageButtonHolder(view);*/
        return null;
    }

    @Override
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int position) {
        SMEMessage message = mMessages.get(position);
    ...
    public int getItemViewType(int position) {
        SMEMessage message = (SMEMessage) mMessages.get(position);
    ...
    private class SentMessageHolder extends RecyclerView.ViewHolder {
        ...
        void bind(final SMEMessage message) {
