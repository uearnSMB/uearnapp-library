...
public class EncUtil {
    ...
    private static final String FIXED_IV = "31180_31182_"; // to randomize the encrypted data( give any values to randomize)
    private static final String KEY_ALIAS = "CHAT_SMBZ"; //give any key alias based on your application. It is different from the key alias used to sign the app.
