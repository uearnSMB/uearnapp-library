...
import smarter.uearn.money.activities.ProcessSelectionActivity;
...
public class ProcessSelectionAdapter extends ArrayAdapter<String> {
    ...
    public ProcessSelectionAdapter(@NonNull Context context, @LayoutRes int resource, @NonNull List<String> objects) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        Typeface faceRegular = Typeface.createFromAsset(SmarterSMBApplication.getInstance().getAssets(), "fonts/poppins.medium.ttf");
        checkBoxHolder.rowTitle.setTypeface(faceRegular);
        checkBoxHolder.rowTitle.setTextSize(14);
        ...
        checkBoxHolder.rowIsDone.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean checked) {
                ...
                if (checked) {
                    ...
                    ischecked(pos, true);
                    ProcessSelectionActivity.noOfCheckboxChecked++;
                    ...
                    if (rowTitle != null && !rowTitle.isEmpty()) {
                        ProcessSelectionActivity.currentSelectedCheckBoxValue = rowTitle;
                    } else {
                        ProcessSelectionActivity.currentSelectedCheckBoxValue = "";
                    }
                    if (rowTitle != null && !rowTitle.isEmpty() && rowTitle.equals("None of the above")) {
                        ProcessSelectionActivity.noneOfTheAboveChecked++;
                    }
                } else {
                    ProcessSelectionActivity.noOfCheckboxChecked--;
