...
//            position = divided + offset + 1;
        ...
        for (int i = 0; i < childSize; i++) {
            ...
            if (position == i) {
                itemView.setTextColor(Color.parseColor("#e40f59"));
                Typeface facebold = Typeface.createFromAsset(SmarterSMBApplication.getInstance().getAssets(), "fonts/poppins_bold.ttf");
                itemView.setTypeface(facebold);
            } else {
                itemView.setTextColor(Color.parseColor("#d9d6d2"));
                Typeface faceRegular = Typeface.createFromAsset(SmarterSMBApplication.getInstance().getAssets(), "fonts/poppins_regular.ttf");
                itemView.setTypeface(faceRegular);
            }
        }
    }
