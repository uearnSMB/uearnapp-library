package com.fourmob.timepicker;
/*
...
import com.fourmob.datepicker.Utils;
...
public class TimePickerDialog extends DialogFragment implements RadialPickerLayout.OnValueSelectedListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mCancelButton.setOnKeyListener(keyboardListener);
    ...
    private void setCurrentItemShowing(int index, boolean animateCircle, boolean delayLabelAnimate,
        ...
        mHourView.setTextColor(mWhite);
        mMinuteView.setTextColor(mWhite);
