...
//	OnAddNewEventClick mAddEvent;
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if(position >= 0 && position < 7){
            ...
            FrameLayout reminderday = v.findViewById(R.id.reminderday_frame);
			...
			if(day.getNumOfEvenets() > 0){
				...
				if(colors.contains(0)){
					//iv.setVisibility(View.VISIBLE);
                    dayTV.setTextColor(Color.parseColor("#39B54A"));
                    if(today.getVisibility() == View.GONE)
	...
	public void refreshDays(ProgressDialog waitDialog)
    {
    	// clear items
    	dayList.clear();
